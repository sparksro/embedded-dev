...
#include"tm4c123gh6pm.h"
 //I believe this to be the correct header file for my board and is the only version I could locate.
// If you take a look at some of the define statement in this file you will note most are of the type volitile
// this tells the compiler that the object might change even though no statements in the program appear to change it.
...
// The port address he has referenced are the same on this board.


// Change code to use predefined macros -prev def and calls left in but commented out
 ...
 int main()
{
      ...
      //GPIOF_DIR = 14;// set F block pin direction as output
